...
export const User = ({obj, onClickInvite, isInvited}) => (
  <li >
    <div>
      <img className="avatar" src={obj.avatar} alt="User" />
      <div>
    ...
    <img onClick={() => onClickInvite(obj.id)} className="action" src={`/assets/${isInvited ? 'minus' : 'plus' }.svg`} alt="Action" />
  </li>
);
